...
(1) `pkg install gmake wget git-lite autoheader libtool autoconf automake`, needed to build ModSecurity below, and for wget below. Feel free to use `fetch` instead of `wget`.
